...
extractor_path = os.path.join(ckpt_dir, 'p3_3_1_extractor.pth')
predictor_path = os.path.join(ckpt_dir, 'p3_3_1_predictor.pth')
...
plt.title("S->M Training Loss")
plt.plot(train_losses,label="train")
plt.xlabel("iterations")
plt.ylabel("Loss")
plt.legend()
plt.savefig("./p3_logs/3_3_1_Loss.png")
...
print(f"Source: MNIST-M, Target: MNIST-M, Acc = {test_acc:.5f}")
