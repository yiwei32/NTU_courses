...
extractor_path = os.path.join(ckpt_dir, 'p3_3_3_extractor.pth')
predictor_path = os.path.join(ckpt_dir, 'p3_3_3_predictor.pth')
...
plt.title("S->S Training Loss")
plt.plot(train_losses,label="train")
plt.xlabel("iterations")
plt.ylabel("Loss")
plt.legend()
plt.savefig("./p3_logs/3_3_3_Loss.png")
...
print(f"Source: SVHN, Target: SVHN, Acc = {test_acc:.5f}")
