...
for epoch in range(num_epochs):
    ...
    torch.save(feature_extractor.state_dict(), os.path.join(ckpt_dir, f'p3_2_svhn_extractor_model.pth'))
    torch.save(label_predictor.state_dict(), os.path.join(ckpt_dir, f'p3_2_svhn_predictor_model.pth'))
...
print(f"Source: USPS, Target: SVHN, Acc = {test_acc:.5f}")
