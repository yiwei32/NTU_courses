...
extractor_path = os.path.join(ckpt_dir, 'p3_3_2_extractor.pth')
predictor_path = os.path.join(ckpt_dir, 'p3_3_2_predictor.pth')
...
plt.title("U->U Training Loss")
plt.plot(train_losses,label="train")
plt.xlabel("iterations")
plt.ylabel("Loss")
plt.legend()
plt.savefig("./p3_logs/3_3_2_Loss.png")
...
print(f"Source: USPS, Target: USPS, Acc = {test_acc:.5f}")
