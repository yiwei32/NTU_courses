...
extractor_path = os.path.join(ckpt_dir, 'p3_1_3_extractor.pth')
predictor_path = os.path.join(ckpt_dir, 'p3_1_3_predictor.pth')
...
plt.title("U->S Training Loss")
plt.plot(train_losses,label="train")
plt.xlabel("iterations")
plt.ylabel("Loss")
plt.legend()
plt.savefig("./p3_logs/3_1_3_Loss.png")
